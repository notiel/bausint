...
*get_all_device_ports_with_id() returns list of comports with Ostranna devices connected with id devacies
                        (answer 'Ack 0' to 'Ping\r\n <id>') as {1:'COM4'}, {2:'COM4'}, ...
...
class UsbHost:
    ...
    @staticmethod
    def get_all_device_ports_with_id() -> Dict[int, str]:
        """
        scans COM ports and returns all ports with ostranna devices and their id
        :return: dict id: port
        """
        devices = [comport.device for comport in serial.tools.list_ports.comports()]
        result = dict()
