...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.SpinFine = QtWidgets.QDoubleSpinBox(self.GBHand)
        self.SpinFine.setEnabled(False)
        self.SpinFine.setDecimals(4)
        self.SpinFine.setMinimum(-1200000.0)
        self.SpinFine.setMaximum(19.0)
        self.SpinFine.setSingleStep(0.1)
